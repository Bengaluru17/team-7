...
bvfdfhgjjhgcyifr7ugojkbngcfiyguoih;'
';ljihugefpyu[qipa'dgl
;qe'gihqpeugipo[
iiqehgqegqgqegqgqe
<!DOCTYPE html>
...
<head>
	<title>Registration Reaching Hands</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-7 md-margin-bottom-50">
						<h2 class="welcome-title">Welcome to Reaching Hands</h2>
						<p>To Do Write</p><br>
						<div class="row margin-bottom-50">
							<div class="col-sm-4 md-margin-bottom-20">
								<div class="site-statistics">
									<span>To Do Write</span>
									<small>To Do Write</small>
								</div>
							</div>
							<div class="col-sm-4 md-margin-bottom-20">
								<div class="site-statistics">
						...
						<div class="members-number">
							<h3>To Do Write<span class="shop-green">To Do Write</span> To Do Write</h3>
							<img class="img-responsive" src="assets/img/map.png" alt="">
						</div>
					</div>

					<div class="col-md-5">
						<form id="sky-form4" class="log-reg-block sky-form" action="create.php" method="post">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6">
								...
								<center>2014 &copy; Reaching Hands. ALL Rights Reserved.</center>
